...
<html lang="en">
    <head>
        ...
        <title>tasty Brothers Biriyani</title>
    </head>
    <body>
        ...
        <header class="l-header" id="header">
            <nav class="nav bd-container">
                <a href="#" class="nav__logo">Tasty Brothers Biriyani</a>
                ...
                <div class="nav__menu" id="nav-menu">
                    ...
                    <div class="box">
                      ...
                      <button class="btn-buy" id="place-order-btn">Place Order</button>
        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">Tasty Brothers Biriyani</h1>
                        <h2 class="home__subtitle">Try the best food of <br> the week.</h2>
                        <a href="#menu" class="button">View Menu</a>
                    </div>
    
                    <img src="assest/img/home1.png" alt="" class="home__img">
                </div>
            </section>
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    ...
                    <img src="assest/img/about.png" alt="" class="about__img">
                </div>
            </section>
            ...
            <section class="menu section bd-container" id="menu">
                ...
                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img src="assest/img/fishcurry.jpg" alt="" class="menu__img">
                        <h3 class="menu__name">Kerala Fish Curry</h3>
                        <span class="menu__detail">Delicious dish</span>
                        <span class="menu__preci">Rs.350</span>
                        <ion-icon name="cart" class="add-cart"></ion-icon>
                    </div>
                    <div class="menu__content">
                        <img src="assest/img/chicken tikka.jpg" alt="" class="menu__img">
                        <h3 class="menu__name">Chicken Tikka</h3>
                        <span class="menu__detail">Delicious dish</span>
                        <span class="menu__preci">Rs.150</span>
                        <ion-icon name="cart" class="add-cart"></ion-icon>
                    </div>

                    <div class="menu__content">
                        <img src="assest/img/chicken.jpg" alt="" class="menu__img">
                        <h3 class="menu__name">Chicken Barbeque</h3>
                        <span class="menu__detail">Delicious dish</span>
                        <span class="menu__preci">Rs.360</span>
                        <ion-icon name="cart" class="add-cart"></ion-icon>
                    </div>
                    
                    <div class="menu__content">
                        <img src="assest/img/mutton.jpg" alt="" class="menu__img">
                        <h3 class="menu__name">Mutton briyani</h3>
                        <span class="menu__detail">Delicious dish</span>
                        <span class="menu__preci">Rs.480</span>
                        <ion-icon name="cart" class="add-cart"></ion-icon>
                    </div>
                    <div class="menu__content">
                        <img src="assest/img/chickenbriyani.jpg" alt="" class="menu__img">
                        <h3 class="menu__name">Hyderabadi Chicken Biryani</h3>
                        <span class="menu__detail">Delicious dish</span>
                        <span class="menu__preci">Rs.350</span>
                        <ion-icon name="cart" class="add-cart"></ion-icon>
                    </div>
                ...
                <div class="app__container bd-grid">
                    <div class="app__data">
                        ...
                        <div class="app__stores">
                            <a href="#"><img src="assest/img/app1.png" alt="" class="app__store"></a>
                            <a href="#"><img src="assest/img/app2.png" alt="" class="app__store"></a>
                        </div>
                    </div>

                    <img src="assest/img/mobile.png" alt="" class="app__img">
                </div>
            </section>
            ...
            <div class="footer__container bd-grid">
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        ...
                        <li>chennai</li>
                        <li>+918838664140</li>
                        <li>vigneshmanikandan2801.com</li>
                    </ul>
                </div>
            </div>

            <p class="footer__copy">&#169; 2024 Gopal brothers. All right reserved</p>
        </footer>
  ...
  placeOrderBtn.addEventListener('click', function() {
    // Logic to create or display the billing page
    // (This part will be explained further)
  });
  placeOrderBtn.addEventListener('click', function() {
  window.location.href = "place.php"; // Redirect to billing page
});
placeOrderBtn.addEventListener('click', function() {
  // Create the billing form elements here (using DOM manipulation)
  // ...

  // Optionally, hide the cart and display the billing form
  const cart = document.querySelector('.cart');
  cart.style.display = 'none';

  const billingForm = document.getElementById('billing-form'); // Assuming you have a hidden element with ID "billing-form"
...
//         //checking the password with hashed password
